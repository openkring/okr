...
export const AOC_I18N_KEYS = {
  ...
  chat_repair_tenants:                      PFX + 'chat.repair.tenants.label',
  chat_repair_tenants_description:          PFX + 'chat.repair.tenants.description',
  chat_repair_tenants_scan:                 PFX + 'chat.repair.tenants.scan',
  chat_repair_tenants_action:               PFX + 'chat.repair.tenants.action',
  ...
  chat_repair_postpolicy:                   PFX + 'chat.repair.postpolicy.label',
  chat_repair_postpolicy_description:       PFX + 'chat.repair.postpolicy.description',
  chat_repair_postpolicy_action:            PFX + 'chat.repair.postpolicy.action',
  chat_repair_postpolicy_confirm:           PFX + 'chat.repair.postpolicy.confirm',
  ...
  content_copy_okey:                        PFX + 'content.copy.okey',
  ...
  hygiene_events_title:                     PFX + 'hygiene.events.title',
  hygiene_events_content:                   PFX + 'hygiene.events.content',
  hygiene_events_button:                    PFX + 'hygiene.events.button',
  hygiene_events_clean:                     PFX + 'hygiene.events.clean',
  hygiene_groups_title:                     PFX + 'hygiene.groups.title',
  hygiene_groups_content:                   PFX + 'hygiene.groups.content',
  hygiene_groups_button:                    PFX + 'hygiene.groups.button',
  hygiene_groups_clean:                     PFX + 'hygiene.groups.clean',
  ...
  allocation_org_select_content:          PFX + 'allocation.orgSelect.content',
  allocation_org_select_button:           PFX + 'allocation.orgSelect.button',
  allocation_card_org:                    PFX + 'allocation.card.org',
  allocation_resource_select_content:     PFX + 'allocation.resourceSelect.content',
  allocation_resource_select_button:      PFX + 'allocation.resourceSelect.button',
  allocation_card_resource:               PFX + 'allocation.card.resource',
  ...
  allocation_topup_title:                 PFX + 'allocation.topup.title',
  allocation_topup_button:                PFX + 'allocation.topup.button',
  allocation_topup_nothing:               PFX + 'allocation.topup.nothing',
