...
export const FIELD_TYPE_DEFS: FieldTypeDef[] = [
  ...
  { type: 'number',    label: 'Number',    icon: 'calculator',   description: 'Numeric input with min/max/step' },
  { type: 'phone',     label: 'Phone',     icon: 'call',         description: 'International phone number (E.164)' },
  { type: 'iban',      label: 'IBAN',      icon: 'card',         description: 'Bank account number (ISO 13616)' },
  ...
  { type: 'file',      label: 'File',      icon: 'attach',       description: 'File upload (stored in bucket)' },
  ...
  { type: 'signature', label: 'Signature', icon: 'pencil',       description: 'Client-side signature capture' },
