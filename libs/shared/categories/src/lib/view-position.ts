import { CategoryModel, HorizontalPosition, VerticalPosition, ViewPosition } from '@okr/shared-models';
...
export const ViewPositions: ViewPositionCategory[] = [
    {
        ...
        abbreviation: 'NONE',
        name: 'none',
        i18nBase: '@shared/categories.view-position.none',
        icon: 'cancel'
    },
    {
        id: ViewPosition.Top,
        abbreviation: 'TOP',
        name: 'top',
        i18nBase: '@shared/categories.view-position.top',
        icon: 'chevron-up'
    },
    {
        ...
        abbreviation: 'BOTTOM',
        name: 'bottom',
        i18nBase: '@shared/categories.view-position.bottom',
        icon: 'chevron-down'
    },
    {
        ...
        abbreviation: 'LEFT',
        name: 'left',
        i18nBase: '@shared/categories.view-position.left',
        icon: 'chevron-back'
    },
    {
        ...
        abbreviation: 'RIGHT',
        name: 'right',
        i18nBase: '@shared/categories.view-position.right',
