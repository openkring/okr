...
const MEMBERSHIP_I18N_KEYS = {
  ...
  member_state_label:               PFX + 'memberState',
  state_helper:                    PFX + 'state.helper',
  bkey_label:                     PFX + 'bkey.label',
  memberid_label:                 PFX + 'memberId.label',
  memberid_placeholder:           PFX + 'memberId.placeholder',
  memberid_helper:                PFX + 'memberId.helper',
  bexioid_label:            PFX + 'memberBexioId.label',
  bexioid_placeholder:      PFX + 'memberBexioId.placeholder',
  bexioid_helper:           PFX + 'memberBexioId.helper',
  ...
  header_category:                PFX + 'header.category',
  header_phone:                   PFX + 'header.phone',
  header_email:                   PFX + 'header.email',
  header_title_rel:               PFX + 'header.titleRel',
