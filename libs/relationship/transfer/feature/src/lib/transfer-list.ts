...
export class TransferList {
  ...
  private addActionSheetButtons(actionSheetOptions: ActionSheetOptions, transfer: TransferModel): void {
    if (!this.readOnly()) {
      actionSheetOptions.buttons.push(createActionSheetButton('transfer.edit', this.store.i18n.update(), this.imgixBaseUrl, 'edit'));
    }
    actionSheetOptions.buttons.push(createActionSheetButton('transfer.view', this.store.i18n.view(), this.imgixBaseUrl, 'eye-on'));
    actionSheetOptions.buttons.push(createActionSheetButton('cancel', this.store.i18n.cancel(), this.imgixBaseUrl, 'cancel'));
    if (hasRole('admin', this.store.appStore.currentUser())) {
      actionSheetOptions.buttons.push(createActionSheetButton('transfer.delete', this.store.i18n.delete(), this.imgixBaseUrl, 'trash'));
    }
