...
import { GenderType, OrgType, Periodicity, WorkingRelModel, WorkingRelState, WorkingRelType } from '@bk2/shared-models';
...
export const workingRelValidations = staticSuite((model: WorkingRelModel, field?: string) => {
  if (field) only(field);
