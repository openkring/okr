...
const RESERVATION_I18N_KEYS = {
  ...
  // ReservationForm keys
  selectLabel:                     '@relationship/reservation/ui.select.label',
  newDesc:                         '@relationship/reservation/ui.newDesc',
  bkey_label:                      '@relationship/reservation/ui.bkey.label',
  bkey_placeholder:                '@relationship/reservation/ui.bkey.placeholder',
  bkey_helper:                     '@relationship/reservation/ui.bkey.helper',
  name_label:                      '@relationship/reservation/ui.name.label',
  name_placeholder:                '@relationship/reservation/ui.name.placeholder',
  name_helper:                     '@relationship/reservation/ui.name.helper',
  participants_label:              '@relationship/reservation/ui.participants.label',
  participants_placeholder:        '@relationship/reservation/ui.participants.placeholder',
  participants_helper:             '@relationship/reservation/ui.participants.helper',
  area_label:                      '@relationship/reservation/ui.area.label',
  area_placeholder:                '@relationship/reservation/ui.area.placeholder',
  area_helper:                     '@relationship/reservation/ui.area.helper',
  resref_label:                    '@relationship/reservation/ui.resref.label',
  resref_placeholder:              '@relationship/reservation/ui.resref.placeholder',
  resref_helper:                   '@relationship/reservation/ui.resref.helper',
  currency_label:                  '@relationship/reservation/ui.currency.label',
  currency_placeholder:            '@relationship/reservation/ui.currency.placeholder',
  currency_helper:                 '@relationship/reservation/ui.currency.helper',
  durationMinutes_label:           '@relationship/reservation/ui.durationMinutes.label',
  durationMinutes_placeholder:     '@relationship/reservation/ui.durationMinutes.placeholder',
  durationMinutes_helper:          '@relationship/reservation/ui.durationMinutes.helper',
  price_label:                     '@relationship/reservation/ui.price.label',
  price_placeholder:               '@relationship/reservation/ui.price.placeholder',
  price_helper:                    '@relationship/reservation/ui.price.helper',
  description_label:               '@relationship/reservation/ui.description.label',
  description_placeholder:         '@relationship/reservation/ui.description.placeholder',
  notes_label:                     '@relationship/reservation/ui.notes.label',
  notes_placeholder:               '@relationship/reservation/ui.notes.placeholder',
  startDate_label:                 '@relationship/reservation/ui.startDate.label',
  startDate_placeholder:           '@relationship/reservation/ui.startDate.placeholder',
  startDate_helper:                '@relationship/reservation/ui.startDate.helper',
  endDate_label:                   '@relationship/reservation/ui.endDate.label',
  endDate_placeholder:             '@relationship/reservation/ui.endDate.placeholder',
  endDate_helper:                  '@relationship/reservation/ui.endDate.helper',
  startTime_label:                 '@relationship/reservation/ui.startTime.label',
  startTime_placeholder:           '@relationship/reservation/ui.startTime.placeholder',
  fullDay_label:                   '@relationship/reservation/ui.fullDay.label',
  fullDay_helper:                  '@relationship/reservation/ui.fullDay.helper',
  // ReservationApplyForm additional keys
  bhcomp_label:                    '@relationship/reservation/ui.bhcomp.label',
  bhcomp_placeholder:              '@relationship/reservation/ui.bhcomp.placeholder',
  bhcomp_helper:                   '@relationship/reservation/ui.bhcomp.helper',
  usesTent_label:                  '@relationship/reservation/ui.usesTent.label',
  usesTent_helper:                 '@relationship/reservation/ui.usesTent.helper',
  isConfirmed_label:               '@relationship/reservation/ui.isConfirmed.label',
  isConfirmed_helper:              '@relationship/reservation/ui.isConfirmed.helper',
