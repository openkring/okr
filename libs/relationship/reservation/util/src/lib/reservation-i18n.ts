...
export const RESERVATION_I18N_KEYS = {
  ...
  export_reserver:                PFX + 'export.reserver',
  export_resource:                PFX + 'export.resource',
  export_name:                    PFX + 'export.name',
  export_startDate:               PFX + 'export.startDate',
  export_startTime:               PFX + 'export.startTime',
  export_fullDay:                 PFX + 'export.fullDay',
  export_duration:                PFX + 'export.duration',
  export_endDate:                 PFX + 'export.endDate',
  export_state:                   PFX + 'export.state',
  export_reason:                  PFX + 'export.reason',
  export_participants:            PFX + 'export.participants',
  export_area:                    PFX + 'export.area',
  export_ref:                     PFX + 'export.ref',
  ...
  export_reserverKey:             PFX + 'export.reserverKey',
  export_resourceKey:             PFX + 'export.resourceKey',
  export_yes:                     PFX + 'export.yes',
  export_no:                      PFX + 'export.no',
