...
const GROUP_I18N_KEYS = {
  ...
  // form field keys (from @bk2/subject-group-ui GroupForm)
  attributes:                      '@subject/group/ui.field.attributes',
  groupId:                         '@subject/group/ui.field.groupId',
  display:                         '@subject/group/ui.field.display',
  access:                          '@subject/group/ui.field.access',
  bkey_label:                      '@subject/group/ui.bkey.label',
  bkey_placeholder:                '@subject/group/ui.bkey.placeholder',
  bkey_helper:                     '@subject/group/ui.bkey.helper',
  groupId_label:                   '@subject/group/ui.groupId.label',
  groupId_placeholder:             '@subject/group/ui.groupId.placeholder',
  groupId_helper:                  '@subject/group/ui.groupId.helper',
  name_label:                      '@subject/group/ui.name.label',
  name_placeholder:                '@subject/group/ui.name.placeholder',
  name_helper:                     '@subject/group/ui.name.helper',
  icon_label:                      '@subject/group/ui.icon.label',
  icon_placeholder:                '@subject/group/ui.icon.placeholder',
  icon_helper:                     '@subject/group/ui.icon.helper',
  visibility_label:                '@subject/group/ui.visibility.label',
  visibility_placeholder:          '@subject/group/ui.visibility.placeholder',
  visibility_helper:               '@subject/group/ui.visibility.helper',
  notes_label:                     '@subject/group/ui.notes.label',
  notes_placeholder:               '@subject/group/ui.notes.placeholder',
  notifyType_label:                '@subject/group/ui.notifyType.label',
  hasContent_label:                '@subject/group/ui.hasContent.label',
  hasContent_helper:               '@subject/group/ui.hasContent.helper',
  hasChat_label:                   '@subject/group/ui.hasChat.label',
  hasChat_helper:                  '@subject/group/ui.hasChat.helper',
  hasCalendar_label:               '@subject/group/ui.hasCalendar.label',
  hasCalendar_helper:              '@subject/group/ui.hasCalendar.helper',
  hasTasks_label:                  '@subject/group/ui.hasTasks.label',
  hasTasks_helper:                 '@subject/group/ui.hasTasks.helper',
  hasFiles_label:                  '@subject/group/ui.hasFiles.label',
  hasFiles_helper:                 '@subject/group/ui.hasFiles.helper',
  hasAlbum_label:                  '@subject/group/ui.hasAlbum.label',
  hasAlbum_helper:                 '@subject/group/ui.hasAlbum.helper',
  hasMembers_label:                '@subject/group/ui.hasMembers.label',
  hasMembers_helper:               '@subject/group/ui.hasMembers.helper',
