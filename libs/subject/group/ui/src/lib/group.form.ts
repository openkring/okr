    ...
    <form novalidate>
      ...
      @if(currentUser(); as currentUser) {
        <okr-avatars name="groupAdmins"
          ...
          [readOnly]="isReadOnly()"
          [title]="i18n().admins_title()"
          [description]="i18n().admins_description()"
        />
      }
          ...
          <ion-card-content class="ion-no-padding">
            <ion-grid>
              <ion-row>
                ...
                <ion-col size="12">
                  <okr-string-select [i18n]="chatModeI18n()"
                    [selectedString]="chatMode()" (selectedStringChange)="onFieldChange('chatMode', $event)"
                    [stringList]="chatModeOptions"
                    [readOnly]="isReadOnly()"
                  />
                </ion-col>
              </ion-row>
