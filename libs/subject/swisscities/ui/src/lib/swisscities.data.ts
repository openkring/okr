...
/**
 * sources:  
 * - https://www.swisstopo.admin.ch/de/amtliches-ortschaftenverzeichnis.html
 * - download csv, sort fields and entries in excel/numbers, export as csv, convert to json (https://www.csvjson.com/csv2json)
 */
