...
const PERSON_I18N_KEYS = {
  ...
  email_label:              '@subject/person/ui.email.label',
  email_placeholder:        '@subject/person/ui.email.placeholder',
  phone_label:              '@subject/person/ui.phone.label',
  phone_placeholder:        '@subject/person/ui.phone.placeholder',
  ...
  // person-new form field keys
  streetName_label:         '@subject/person/ui.streetName.label',
  streetName_placeholder:   '@subject/person/ui.streetName.placeholder',
  streetName_helper:        '@subject/person/ui.streetName.helper',
  streetNumber_label:       '@subject/person/ui.streetNumber.label',
  streetNumber_placeholder: '@subject/person/ui.streetNumber.placeholder',
  streetNumber_helper:      '@subject/person/ui.streetNumber.helper',
  countryCode_label:        '@subject/person/ui.countryCode.label',
  countryCode_placeholder:  '@subject/person/ui.countryCode.placeholder',
  countryCode_helper:       '@subject/person/ui.countryCode.helper',
  zipCode_label:            '@subject/person/ui.zipCode.label',
  zipCode_placeholder:      '@subject/person/ui.zipCode.placeholder',
  zipCode_helper:           '@subject/person/ui.zipCode.helper',
  city_label:               '@subject/person/ui.city.label',
  city_placeholder:         '@subject/person/ui.city.placeholder',
  city_helper:              '@subject/person/ui.city.helper',
  web_label:                '@subject/person/ui.web.label',
  web_placeholder:          '@subject/person/ui.web.placeholder',
  web_helper:               '@subject/person/ui.web.helper',
  dateOfEntry_label:        '@subject/person/ui.dateOfEntry.label',
  dateOfEntry_placeholder:  '@subject/person/ui.dateOfEntry.placeholder',
  dateOfEntry_helper:       '@subject/person/ui.dateOfEntry.helper',
  shouldAddMembership_label:  '@subject/person/ui.shouldAddMembership.label',
  shouldAddMembership_helper: '@subject/person/ui.shouldAddMembership.helper',
  personDetails:    '@subject/person/ui.details',
  personAddress:    '@subject/person/ui.address',
  personMisc:       '@subject/person/ui.misc',
  personMembership: '@subject/person/ui.membership',
  selectLabel:      '@subject/person/ui.select',
