...
export const DOCUMENT_I18N_KEYS = {
  ...
  vectorize:            '@document/feature.vectorize.label',
  vectorize_title:      '@document/feature.vectorize.title',
  vectorize_source:     '@document/feature.vectorize.source',
  vectorize_result:     '@document/feature.vectorize.result',
  vectorize_preset:     '@document/feature.vectorize.preset.label',
  vectorize_preset_logo:  '@document/feature.vectorize.preset.logo',
  vectorize_preset_photo: '@document/feature.vectorize.preset.photo',
  vectorize_detail:     '@document/feature.vectorize.detail',
  vectorize_generate:   '@document/feature.vectorize.generate',
  vectorize_hint:       '@document/feature.vectorize.hint',
  vectorize_empty:      '@document/feature.vectorize.empty',
  vectorize_error:      '@document/feature.vectorize.error',
