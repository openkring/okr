        ...
        <ion-grid>
          <ion-row>
            ...
            <ion-col size="12" size-md="6"> 
              <bk-category-old name="albumStyle" [value]="albumStyle()" (valueChange)="onFieldChange('albumStyle', $event)" [categories]="albumStyles" [readOnly]="readOnly()" />
            </ion-col>
            <ion-col size="12" size-md="6">
            ...
            <ion-col size="12" size-md="6">
              <bk-category-old name="effect" [value]="effect()" (valueChange)="onFieldChange('effect', $event)" [categories]="galleryEffects" [readOnly]="readOnly()" />
            </ion-col>
          </ion-row>
        </ion-grid>
      </ion-card-content>
