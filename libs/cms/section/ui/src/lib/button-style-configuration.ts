...
import { CategoryOld, StringSelect, TextInput } from '@bk2/shared-ui';
      ...
      <ion-card-content>
        ...
        <ion-grid>
          <ion-row>
              ...
              <ion-col size="12">
                  <bk-category-old name="color" [value]="color()" (valueChange)="onFieldChange('color', $event)" [categories]="colors" [readOnly]="readOnly()" />
              </ion-col>
          </ion-row>
        </ion-grid>
      </ion-card-content>
