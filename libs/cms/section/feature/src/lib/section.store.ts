...
export const SECTION_I18N_KEYS = {
  ...
  weekday_mo:                     PFX + 'weekDayAbbreviation.monday',
  weekday_di:                     PFX + 'weekDayAbbreviation.tuesday',
  weekday_mi:                     PFX + 'weekDayAbbreviation.wednesday',
  weekday_do:                     PFX + 'weekDayAbbreviation.thursday',
  weekday_fr:                     PFX + 'weekDayAbbreviation.friday',
  weekday_sa:                     PFX + 'weekDayAbbreviation.saturday',
  weekday_so:                     PFX + 'weekDayAbbreviation.sunday',
  ...
  tasks_empty:                    PFX + 'tasks.empty',
  orgchart_accordion:             PFX + 'orgchart.view.accordion',
  orgchart_chart:                 PFX + 'orgchart.view.chart',
  rag_placeholder:                PFX + 'rag.placeholder',
  rag_upload:                     PFX + 'rag.upload',
  album_zoomed:                   PFX + 'album.zoomed',
  album_style:                    PFX + 'albumStyle.label',
  ...
  member_age_group:                PFX + 'memberAge.ageGroup',
  member_age_male:                 PFX + 'memberAge.male',
  member_age_female:               PFX + 'memberAge.female',
  member_age_total:                PFX + 'memberAge.total',
  member_age_empty:                PFX + 'memberAge.empty',
