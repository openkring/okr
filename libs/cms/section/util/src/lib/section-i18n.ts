...
export const SECTION_I18N_KEYS = {
  ...
  button_action_intro:        PFX + 'buttonAction.intro',
  chat_type_description:      PFX + 'chat.type.description',
  slider_next_image:          PFX + 'slider.nextImage',
  slider_prev_image:          PFX + 'slider.prevImage',
  ...
  group_singular:             '@subject/group/feature.group',
  ...
  // album context menu (c-album): bulk download, CSV export, subfolder, cover picker
  album_download_header:                    PFX + 'album.download.header',
  album_download_confirm:                   PFX + 'album.download.confirm',
  album_download_start:                     PFX + 'album.download.start',
  album_download_done:                      PFX + 'album.download.done',
  ...
  album_cover_apply:                        PFX + 'album.cover.apply',
  album_cover_empty:                        PFX + 'album.cover.empty',
  album_style_header:                       PFX + 'album.style.header',
  album_csv_name:                           PFX + 'album.csv.name',
  album_csv_title:                          PFX + 'album.csv.title',
  album_csv_type:                           PFX + 'album.csv.type',
  album_csv_size:                           PFX + 'album.csv.size',
  album_csv_author:                         PFX + 'album.csv.author',
  ...
  album_folder_label:                       PFX + 'album.folder.label',
  album_folder_placeholder:                 PFX + 'album.folder.placeholder',
  album_folder_helper:                      PFX + 'album.folder.helper',
  ...
  image_overwrite_title:                    PFX + 'image.overwrite.label',
  image_overwrite_message:                  PFX + 'image.overwrite.confirm',

  // image
  image:                                    PFX + 'image.label',
  ...
  image_upload_logo:                        PFX + 'image.upload.logo',
  image_upload_hero:                        PFX + 'image.upload.hero',
  image_config_title:                       PFX + 'image.config.title',
  image_overwrite:                          PFX + 'image.overwrite.label',
  image_overwrite_confirm:                  PFX + 'image.overwrite.confirm',
  image_overwrite_conf:                     PFX + 'image.overwrite.conf',
  ...
  responsibility_okey_placeholder:          PFX + 'responsibility.okey.placeholder',
  responsibility_okey_helper:               PFX + 'responsibility.okey.helper',
